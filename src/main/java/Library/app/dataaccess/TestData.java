...
public class TestData {
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			add(new Book("23-11451", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1)),2));
			add(new Book("28-12331", "Antartica", 7, Arrays.asList(allAuthors.get(2)),2));
			add(new Book("99-22223", "Thinking Java", 21, Arrays.asList(allAuthors.get(3)),1));
			add(new Book("48-56882", "Jimmy's First Day of School", 7, Arrays.asList(allAuthors.get(4)),5));
